...
from src.chat.router.voice_router import router as voice_router
...
# 2. Rutas Voice -> POST /chats/tts, POST /chats/stt
chat_router.include_router(voice_router)

# 3. Rutas WebSocket (WS) -> WS /chats/ws/{guid}
